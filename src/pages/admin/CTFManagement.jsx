...
//     return (
//       <div
//         className={`px-3 py-1.5 rounded-lg text-sm font-medium flex items-center space-x-2 ${config.color}`}
//       >
...
//               Manage your CTF challenges and their visibility
//             </p>
//           </div>
...
//                           </span>
//                         </td>
//                         <td className="px-4 py-4">{getStatusBadge(ctf)}</td>
//                         <td className="px-4 py-4">
...
//                   Visibility
//                 </label>
//                 <div className="mt-1">{getVisibilityBadge(viewCTF)}</div>
//               </div>
