...
export const ctfAPI = {
  ...
  toggleActivation: (ctfId) => api.put(`/admin/ctfs/${ctfId}/toggle-activation`),
  ...
  exportCTFSubmissions: (ctfId) => api.get(`/admin/export/ctfs/${ctfId}/submissions`, { responseType: 'blob' }),
